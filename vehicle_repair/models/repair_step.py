...
REPAIR_STEP_STATUS_CHOICES = [
    ...
    (REPAIR_STEP_STATUS_COMPLETED, REPAIR_STEP_STATUS_COMPLETED.capitalize()),
    (REPAIR_STEP_STATUS_CANCELLED, REPAIR_STEP_STATUS_CANCELLED.capitalize())
]


class RepairStep(BaseModelMixin):
    repair_request = models.ForeignKey("vehicle_repair.VehicleRepairRequest",
                                       on_delete=models.CASCADE, related_name="repair_steps")
