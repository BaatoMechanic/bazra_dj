...
from permission.app_permissions_list.vehicle_repair_permissions import (REPAIR_REQUEST_LOCATION_API, REPAIR_STEP_READ_API, REPAIR_STEP_WRITE_API, SERVICE_READ_API, SERVICE_WRITE_API, VEHICLE_CATEOGRY_READ_API, VEHICLE_CATEOGRY_WRITE_API,
