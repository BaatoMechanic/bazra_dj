...
VEHICLE_REPAIR_STATUS_WAITING_FOR_USER_ACCEPTANCE = "waiting_for_user_acceptance"
VEHICLE_REPAIR_STATUS_WAITING_FOR_ADVANCE_PAYMENT = "waiting_for_advance_payment"
VEHICLE_REPAIR_STATUS_WAITING_FOR_MECHANIC = "waiting_for_mechanic"
VEHICLE_REPAIR_STATUS_WAITING_FOR_REVIEW = "waiting_for_review"
...
VEHICLE_REPAIR_STATUS_CHOICES = [
    ...
    (
        VEHICLE_REPAIR_STATUS_WAITING_FOR_USER_ACCEPTANCE,
        VEHICLE_REPAIR_STATUS_WAITING_FOR_USER_ACCEPTANCE.capitalize(),
    ),
    (
        VEHICLE_REPAIR_STATUS_WAITING_FOR_ADVANCE_PAYMENT,
        VEHICLE_REPAIR_STATUS_WAITING_FOR_ADVANCE_PAYMENT.capitalize(),
    ),
    (
        VEHICLE_REPAIR_STATUS_WAITING_FOR_MECHANIC,
        VEHICLE_REPAIR_STATUS_WAITING_FOR_MECHANIC.capitalize(),
    ),
    (
        VEHICLE_REPAIR_STATUS_WAITING_FOR_REVIEW,
        VEHICLE_REPAIR_STATUS_WAITING_FOR_REVIEW.capitalize(),
    ),
...
ADVANCE_PAYMENT_STATUS_CHOICES = [
    ...
    (
        ADVANCE_PAYMENT_STATUS_PAYMENT_ON_ARRIVAL,
        ADVANCE_PAYMENT_STATUS_PAYMENT_ON_ARRIVAL.capitalize(),
    ),
]
...
class VehicleRepairRequest(BaseModelMixin):
    ...
    status = models.CharField(
        max_length=255,
        default=VEHICLE_REPAIR_STATUS_PENDING,
    ...
    def can_retrieve(self, request: HttpRequest) -> bool:
        ...
        if request_user.isa(["Superuser", "Mechanic"]):
            return True
